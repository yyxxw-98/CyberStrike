...
export const TESTER_VRT_SCOPE: Record<string, string[]> = {
  idor: ["idor", "bola"],
  authz: ["privilege escalation", "auth bypass", "broken access control", "access control", "bfla", "cors", "forbidden"],
  injection: ["sqli", "sql injection", "nosqli", "xss", "cross-site scripting", "ssti", "xxe", "command injection", "ldap"],
  authn: ["auth bypass", "authentication", "session", "jwt", "rate limit", "brute", "password", "mfa", "2fa", "credential", "default creds", "token"],
  ssrf: ["ssrf", "server-side request"],
  "file-attacks": ["path traversal", "directory traversal", "lfi", "rfi", "file upload", "file inclusion", "insecure file access", "zip slip"],
