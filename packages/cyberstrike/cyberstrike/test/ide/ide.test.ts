...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CYBERSTRIKE_CALLER", () => {
    process.env["CYBERSTRIKE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CYBERSTRIKE_CALLER", () => {
    process.env["CYBERSTRIKE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CYBERSTRIKE_CALLER", () => {
    process.env["CYBERSTRIKE_CALLER"] = "unknown"
