...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/cyberstrike.git")).toEqual({ owner: "sst", repo: "cyberstrike" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/cyberstrike")).toEqual({ owner: "sst", repo: "cyberstrike" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/cyberstrike.git")).toEqual({ owner: "sst", repo: "cyberstrike" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/cyberstrike")).toEqual({ owner: "sst", repo: "cyberstrike" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/cyberstrike.git")).toEqual({ owner: "sst", repo: "cyberstrike" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/cyberstrike")).toEqual({ owner: "sst", repo: "cyberstrike" })
})
