...
test("parses valid share URLs", () => {
  expect(parseShareUrl("https://cybrstk.us/share/Jsj3hNIW")).toBe("Jsj3hNIW")
...
test("rejects invalid URLs", () => {
  expect(parseShareUrl("https://cybrstk.us/s/Jsj3hNIW")).toBeNull() // legacy format
  expect(parseShareUrl("https://cybrstk.us/share/")).toBeNull()
  expect(parseShareUrl("https://cybrstk.us/share/id/extra")).toBeNull()
